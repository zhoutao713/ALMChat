...
public class DatabaseUtil {
	 private static final String TAG="DatabaseUtil";
	    ...
	    public void deleteFav(QiangYu qy){
	    	Cursor cursor=null;
	    	String where = FavTable.USER_ID+" = '"+ALMApplication.getInstance().getCurrentUser().getBmobUser().getObjectId()
	    ...
	    public long insertFav(QiangYu qy){
            ...
            if(cursor != null && cursor.getCount() > 0) {
		    	...
		    	ContentValues cv = new ContentValues();
		    	cv.put(FavTable.USER_ID, ALMApplication.getInstance().getCurrentUser().getBmobUser().getObjectId());
		...
		public List<QiangYu> setFav(List<QiangYu> lists) {
	        ...
	        if(lists != null && lists.size() > 0) {
	            for(Iterator iterator=lists.iterator(); iterator.hasNext();) {
	            	...
	            	String where = FavTable.USER_ID+" = '"+ALMApplication.getInstance().getCurrentUser().getBmobUser().getObjectId()//content.getAuthor().getObjectId()
