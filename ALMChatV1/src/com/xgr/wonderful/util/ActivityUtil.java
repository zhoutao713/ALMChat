package com.xgr.wonderful.util;
...
public final class ActivityUtil {
    ...
    public static int[] getScreenSize() {
        ...
        dm=ALMApplication.getInstance().getResources().getDisplayMetrics();
    ...
    public static void show(final Context context, final String message) {
        final String msg=msgFilter != null ? msgFilter.filter(message) : message;
        ALMApplication.getInstance().getTopActivity().runOnUiThread(new Runnable() {

            public void run() {
                // Toast.makeText(activity, msg, Toast.LENGTH_SHORT).show();
                Toast toast=ToastFactory.getToast(ALMApplication.getInstance().getTopActivity(), message);
