...
//		mSlidingMenu = mHelper.getSlidingMenu();
//		sliding = new SlidingFragmentActivity();
//		initFragment(sliding);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				if (username.equals(ALMApplication.getInstance().getUserName()))
...
/*	private void initFragment(SlidingFragmentActivity sliding) {
		mSlidingMenu = sliding.getSlidingMenu();
		sliding.setBehindContentView(R.layout.frame_navi); // 给滑出的slidingmenu的fragment制定layout
		naviFragment = new NaviFragment();
		sliding.getSupportFragmentManager().beginTransaction()
