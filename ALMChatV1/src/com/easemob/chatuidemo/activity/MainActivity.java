...
//		MobclickAgent.setDebugMode( true );
		...
		wonderfulFragment=new WonderfulFragment();
		fragments = new Fragment[] { chatHistoryFragment, contactListFragment,wonderfulFragment, settingFragment};
		// 添加显示第一个fragment
		getSupportFragmentManager().beginTransaction().add(R.id.fragment_container, chatHistoryFragment)
				.add(R.id.fragment_container, contactListFragment).hide(contactListFragment)
				.add(R.id.fragment_container,wonderfulFragment).hide(wonderfulFragment).
	...
	private void initView() {
		...
		mTabs[2] = (Button) findViewById(R.id.btn_wonder_list);
	...
	public int getUnreadAddressCountTotal() {
		...
		if (ALMApplication.getInstance().getContactList().get(Constant.NEW_FRIENDS_USERNAME) != null)
			unreadAddressCountTotal = ALMApplication.getInstance().getContactList().get(Constant.NEW_FRIENDS_USERNAME).getUnreadMsgCount();
...
//			message.getStringAttribute("");
	...
	private class MyContactListener implements EMContactListener {
		...
		public void onContactAdded(List<String> usernameList) {
			// 保存增加的联系人
			Map<String, EUser> localUsers = ALMApplication.getInstance().getContactList();
			Map<String, EUser> toAddUsers = new HashMap<String, EUser>();
			for (String username : usernameList) {
				EUser user = setUserHead(username);
				// 添加好友时可能会回调added方法两次
	...
	private void saveInviteMsg(InviteMessage msg) {
		...
		// 未读数加1
		EUser user = ALMApplication.getInstance().getContactList().get(Constant.NEW_FRIENDS_USERNAME);
	 ...
	 * @return
	 */
	EUser setUserHead(String username) {
