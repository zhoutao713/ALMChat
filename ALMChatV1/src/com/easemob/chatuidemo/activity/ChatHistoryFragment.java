...
public class ChatHistoryFragment extends Fragment {
	...
	private Map<String, EUser> contactList;
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		// contact list
		contactList = ALMApplication.getInstance().getContactList();
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				if (adapter.getItem(position).getUsername().equals(ALMApplication.getInstance().getUserName()))
	...
	private List<EMContact> loadUsersWithRecentChat() {
		...
		for (EUser user : contactList.values()) {
